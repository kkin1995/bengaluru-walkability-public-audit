...
- [x] 07-11-PLAN.md — TRIAGE-03 status filter intersection: shared status bucketing so In-progress chip never shows Open-bucket reports (TRIAGE-03)
- [x] 07-12-PLAN.md — TRIAGE-04b ward polygon click black focus rectangle removed via SVG outline:none + blur-on-click (TRIAGE-04)
- [x] 07-13-PLAN.md — MOB-03 analytics chart lines: measured explicit-width LineChart replaces ResponsiveContainer so lines paint on mobile load (MOB-03)
...
- [x] 07-06-PLAN.md — Public report detail before/after resolution photo layout (TRIAGE-05)

**Wave 2** *(depends on Wave 1)*

- [x] 07-02-PLAN.md — Public ward boundary endpoint + route conflict fix + nginx cache (TRIAGE-04)

**Wave 3** *(depends on Wave 2)*

- [x] 07-04-PLAN.md — Admin reports queue corp/ward searchable filter selects (TRIAGE-01)
- [x] 07-05-PLAN.md — Public map status filter chips + ward boundary overlay (TRIAGE-03, TRIAGE-04)

**Wave 4** *(depends on Wave 3)*

- [x] 07-07-PLAN.md — Mobile Safari admin layout fixes MOB-01 through MOB-07 (MOB-01–07)
