...
- [ ] 02.5-02-PLAN.md — Login + Dashboard screens (mobile + desktop, light + dark)
- [ ] 02.5-03-PLAN.md — Reports list (card stream + compact rows) + Report detail screen
...
| 2.5 Admin Portal UI Redesign | 0/4 | Not started — UI-SPEC approved | - |
